...
const LiveDetectionInterface = () => {
    ...
    const captureAndSend = useCallback(async () => {
        ...
        try {
            ...
            // Logic cập nhật lịch sử: Chỉ thêm vào log nếu độ tin cậy > 70% và không trùng với từ cuối cùng
    ...
    // Thiết lập vòng lặp dựa trên trạng thái isDetecting
    useEffect(() => {
        let intervalId;
        if (isDetecting) {
